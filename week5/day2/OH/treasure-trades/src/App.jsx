  ...
  return (
    <>
      ...
      <div className="container">
        <Routes>
          <Route path="/" element={[<HomepageImage/>, <FeaturedProducts products={products}/>]}/>
          <Route path='/sellProduct' element={<ProductForm products={products} setProducts={setProducts}/>}/>
        </Routes>
      </div>
    </>
  )
